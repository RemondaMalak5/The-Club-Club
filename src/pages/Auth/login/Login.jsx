...
const Login = () => {
  ...
  <div className="flex-1 flex flex-col justify-center p-20 gap-4">
    ...
    <button className=" w-fit bg-[#00786F] text-white py-2 px-6 rounded-full hover:bg-[#025154] transition">
        Sign In
    </button>
  ...
  <div className="relative  flex flex-col justify-center items-center text-center text-white h-full gap-5 ms-20">
    ...
    <button className="px-8 py-2 rounded-3xl border border-white font-semibold hover:bg-white hover:text-[#025154] transition">
      Register
    </button>
