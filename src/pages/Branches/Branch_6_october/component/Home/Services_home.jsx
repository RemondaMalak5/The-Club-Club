                        ...
                        <div className="bg-white border border-gray-200 rounded-2xl shadow-md overflow-hidden " key={index}>
                            ...
                            <div className="p-5">
                                ...
                                <p className="text-gray-600 mb-4">
                                    {e.description}                            </p>
                                <button onClick={()=>navigate("/branches/6-october/services/details")} className="px-4 py-2  text-[#21857C] rounded-2xl border border-[#21857C] w-full hover:bg-[#21857C] hover:text-white transition-all duration-300">
                                    learn more
                                </button>
                            </div>
                        </div>
